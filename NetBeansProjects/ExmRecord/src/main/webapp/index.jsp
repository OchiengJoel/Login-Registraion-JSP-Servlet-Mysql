<%-- 
    Document   : index
    Created on : Jun 21, 2018, 8:03:17 PM
    Author     : joel
--%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" name="upass"   placeholder="Enter your Password" required="required"/>
                            </div>
                        </div>
                    </div>
